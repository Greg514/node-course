...
const  SERVER = http.createServer((req, res) => {
    if (req.url === "/") {
        res.writeHead(okStatus, {"Content-Type": "text/html"});
        res.write(`
            <!DOCTYPE html>
<html>
<head>
...
`);
    ...
    res.writeHead(notAUthorizedStatus, {"Content-type":"text/html"});
    res.write(`<h1> you are not admin and you must go back to home page</h1>
        <a href="/">Home</a>`);
        res.end();
   }
   else{
    res.writeHead(notFoundStatus, {"Content-type": "text/html"});
    res.write(`
        <doctype html>
<html>
<head>
